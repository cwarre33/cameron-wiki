...
Cohesion: 0.19
Nodes (19): NCAA Bracket Prediction (March Mania), Log Loss and Calibration in Probabilistic Prediction, IMO-Level Mathematical Reasoning (AIMO), Social Action Recognition in Mice (Behavioral Ethology), AI Mathematical Olympiad — Progress Prize 3 ($2.2M), Google Tunix Hackathon — Train a Model to Show Its Work, Predicting Heart Disease — Playground S6E2, House Prices — Advanced Regression Techniques (Rank ~19) (+11 more)
...
Cohesion: 0.18
Nodes (11): ARC-AGI Benchmark Page, AutoTrader Trading Bot Page, Kaggle Portfolio Overview Page, LLM Wiki Pattern (Karpathy) Page, Wiki Index — Master Catalog, SofaScope Production System Page, ARC-AGI Async LLM Test Harness, Cameron's Second Brain — Overview (+3 more)
...
- **Why does `Wiki Index — Master Catalog` connect `Community 2` to `Community 0`, `Community 1`, `Community 5`?**
  _High betweenness centrality (0.126) - this node is a cross-community bridge._
- **Why does `Groq — LLM Inference API` connect `Community 1` to `Community 2`?**
