...
| [CRR — CCS/VCS Custom Round Robin](production-systems/crr-round-robin.md) | Custom Round Robin (CRR) is the Task Server–backed ticket assignment stack for CCS and VCS, with dedicated-agent preference before fair-share fallb... | active | fls-internal | 2026-07-30 |
| [ClearView AWS Hosting](production-systems/clearview-aws-hosting.md) | ECS/Fargate hosting for ClearView — staging + prod — under Build Phase epic initiatives/flsp-103-inventory-lookup.md. | active | fls-internal | 2026-07-30 |
| [ClearView Admin Users / Role Overrides](production-systems/clearview-admin-users.md) | Admin panel: hide by role and ship Users override page for effective-role management. | active | fls-internal | 2026-09-02 |
| [ClearView Microsoft Clarity Telemetry](production-systems/clearview-clarity-telemetry.md) | Microsoft Clarity on ClearView prod for UAT session telemetry — script load, custom events, email/role session tags. | active | fls-internal | 2026-07-30 |
| [ClearView Mobile / iPad Experience](production-systems/clearview-mobile-ipad.md) | Theme-sliced mobile/tablet work under Build Phase: back-navigation scroll, responsive chrome, camera scan on `/items`, render-budget fixes. | active | fls-internal | 2026-09-02 |
| [ClearView Ops Health Check](production-systems/clearview-ops-health.md) | Post-provision ops health across parity, sync logs, and cost after public ALB / hosting landed. | active | fls-internal | 2026-07-30 |
| [ClearView Public ALB + WAF](production-systems/clearview-public-alb-waf.md) | Make ClearView reachable on the public internet (still behind Entra ID), using a second internet-facing ALB + dedicated WAF — rather than remaining... | active | fls-internal | 2026-07-30 |
...
| [ClearView Shop / RMF Requests](production-systems/clearview-shop-rmf-requests.md) | ClearView's Shop Request surface replaces core PIE shop-tracking: queue + detail for active requests, NetSuite custom record as system of record, R... | active | fls-internal | 2026-09-02 |
| [ClearView Shop Notifications](production-systems/clearview-notifications.md) | Subscription email notifications for Shop/RMF request activity — ClearView-originated comments/attachments first, then sync-driven changes from the... | active | fls-internal | 2026-09-02 |
| [ClearView VRA Handoff](production-systems/clearview-vra-handoff.md) | Create Vendor Return from ClearView item detail → NetSuite VRA Suitelet. Lives under the Development epic (adjacent to PIE & Shop), but is part of ... | active | fls-internal | 2026-09-02 |
| [Dedicated Agent Assignment — Zendesk CCS Automation](production-systems/dedicated-agent-assignment.md) | Automatically assigns incoming CCS and Vendor Care tickets to the dedicated agent stored on the requester's user field (`dedicated_agent`), using A... | active | fls-internal | 2026-07-30 |
...
| [Inventory Lookup (ClearView) — Hosted NetSuite Inventory Intelligence](production-systems/inventory-lookup-clearview.md) | ClearView is Furnitureland South's modern Inventory Lookup product for Sales, Merchandising, and Operations: barcode scan, inventory browse, orders... | active | fls-internal | 2026-09-02 |
...
| [Decision — ClearView Dev Role and Admin Self-Edit](decisions/clearview-dev-role-admin-restrict.md) | Context: Shop write-back and Admin Users needed a way for developers to exercise privileged paths without widening production Admin, and Admins sho... | 2026-09-02 |
| [Decision — RMF / Shop Attachment Rendering](decisions/clearview-rmf-attachment-rendering.md) | Context: Post-demo ask — email threads, vendor docs, BOLs, and iPhone image formats must upload and remain usable on Shop/RMF requests. Raw downloa... | 2026-09-02 |
| [Decision — Shop Request Duplicate Guard](decisions/clearview-shop-duplicate-guard.md) | Context: Creating Shop Requests from ClearView (and eventually from status/location triggers) must not open a second active request for the same ba... | 2026-09-02 |
| [Decision — Shop Requests Read Live from NetSuite (Not RDS)](decisions/clearview-shop-live-netsuite-read.md) | Context: Inventory browse/detail/orders use the Postgres RDS read plane (~15 min delta lag). Shop/RMF is an operational queue — status, notes, and ... | 2026-09-02 |
...
| [System Design — ClearView (Hosted Inventory Lookup)](interview-prep/system-design-clearview.md) | Interview preparation grounded in real ClearView production work at Furnitureland South. Hub page: production-systems/inventory-lookup-clearview.md... | 2026-09-02 |
...
| [Open Question — Zendesk Auth Deadlines (API tokens + OAuth)](open-questions/zendesk-oauth-refresh-2026-10.md) | Deadlines: | 2026-07-30 |
