...
| [ClearView Admin Users / Role Overrides](production-systems/clearview-admin-users.md) | Admin panel: hide by role and ship Users override page for effective-role management. | active | fls-internal | 2026-07-30 |
...
| [ClearView Mobile / iPad Experience](production-systems/clearview-mobile-ipad.md) | Theme-sliced mobile/tablet work under Build Phase: back-navigation scroll, responsive chrome, camera scan on `/items`, render-budget fixes. | active | fls-internal | 2026-07-30 |
...
| [Inventory Lookup (ClearView) — Hosted NetSuite Inventory Intelligence](production-systems/inventory-lookup-clearview.md) | ClearView is Furnitureland South's modern Inventory Lookup product for Sales, Merchandising, and Operations: barcode scan, inventory browse, orders... | active | fls-internal | 2026-07-30 |
